...
router.post("/accept-raised-hand", UserAuth, async (req, res) => {
  try {
    ...
    const getChatRoom = await GetOrCreateChatRoom(raised_by, owner, {
      message,
    });
