        ...
        <div className="top-section">
          ...
          <div className="contact_details">
            <span className="email">
              <FaEnvelope /> {decoded.email}
            </span>
            <span className="phone_no">
              <FaMobileAlt /> {decoded.phone}
            </span>
          </div>
        </div>
        <div className="bottom-section">
          <div className='leftpart'>
            <div className="profile-page__field">
              <span className="more_details">Faculty: {decoded.faculty}</span>
            </div>
            <div className="profile-page__field">
              <span className="more_details">Group: {decoded.group}</span>
            </div>
          </div>
        </div>
