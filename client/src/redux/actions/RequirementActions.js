...
export const getAllRequirements = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(
      BASE_URL + "/requirements/get-requirement-feed",
      {
        headers: {
  ...
  (title, description, token) => async (dispatch) => {
    try {
      const res = await axios.post(
        BASE_URL + "/requirements/create-a-requirement",
        {
          title,
          description,
        },
...
export const getAllOwnRequirements = () => async (dispatch) => {
  ...
  try {
    ...
    const decoded = jwt_decode(token);
    const { data } = await axios.get(
      BASE_URL + "/requirements/get-own-requirements",
      {
        headers: {
          authorization: `Bearer ${decoded.auth_token}`,
        },
  ...
  (requirement_id, title, description, token) => async (dispatch) => {
    try {
      const res = await axios.put(
        BASE_URL + "/requirements/edit-a-requirement",
        {
          requirement_id,
          title,
          description,
  ...
  (requirement_id, token) => async (dispatch) => {
    try {
      const res = await axios.delete(
        BASE_URL + "/requirements/delete-requirement",
