...
export const getAllLostFoundItems = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(
      BASE_URL + "/lost-found-items/get-lost-found-feed",
      {
        headers: {
...
export const lostFoundSearch = (searchQuery) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(
      BASE_URL +
        `/lost-found-items/search-lost-found-products?search=${searchQuery}`,
      {
        headers: {
          authorization: `Bearer ${decoded.auth_token}`,
        },
...
export const getLostFoundProductDetails = (itemData) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      BASE_URL +
        `/lost-found-items/get-lost-found-product-details?product_id=${itemData.product_id}`,
      {
        headers: {
...
export const addNewLostFoundItem = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      BASE_URL + "/lost-found-items/create-new-lost-found-product",
      data,
      {
        headers: {
...
export const getAllOwnLostFoundItems = () => async (dispatch) => {
  ...
  try {
    ...
    const decoded = jwt_decode(token);
    const { data } = await axios.get(
      BASE_URL + "/lost-found-items/get-own-lost-found-list",
      {
        headers: {
          authorization: `Bearer ${decoded.auth_token}`,
        },
...
export const editLostFoundItem = (formData) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(
      BASE_URL + "/lost-found-items/edit-lost-found-product",
      formData,
...
export const deleteLostFoundItem = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.delete(
      BASE_URL + "/lost-found-items/delete-lost-found-product",
      {
        headers: {
...
export const markAsFound = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.put(
      BASE_URL + "/lost-found-items/mark-as-found",
      data,
      {
        headers: {
          authorization: `Bearer ${data.token}`,
...
export const raiseHand = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      BASE_URL + "/raisedhands/raise-hand-on-an-item",
      data,
      {
        headers: {
          authorization: `Bearer ${data.token}`,
...
export const getLostFoundItemResponses = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      BASE_URL + "/raisedhands/get-raised-responses",
...
export const acceptRaisedHand = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      BASE_URL + "/raisedhands/accept-raised-hand",
      data,
      {
        headers: {
          authorization: `Bearer ${data.token}`,
...
export const rejectRaisedHand = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.delete(
      BASE_URL + "/raisedhands/reject-raised-hand",
